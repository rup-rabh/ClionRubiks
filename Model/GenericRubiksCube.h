 ...
 * Declaring all Pure Virtual functions here to be defined later in .cpp files
 */
...
public:
    ...
    */
     ...
     */
    static char getColorLetter(COLOR color); //done
     ...
     */
    static string getMove(MOVE ind); //done
     ...
     */
    GenericRubiksCube& move(MOVE ind);  //done

    /*
     * Invert a move
     */
    GenericRubiksCube& invert(MOVE ind); //done
